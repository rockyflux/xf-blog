export const sidebar = {
  ...
  '/tutorials/blog/': [
    {
      ...
      items: [
        ...
        { text: 'Cursor Context 工程化对照：Rules、Subagents、Skills、MCP', link: '/tutorials/blog/2026/01/22/Cursor Context工程化对照 Rules、Subagents、Skills、MCP' },
        { text: 'Cursor 端到端工作流模板：Rules、Subagents、Skills、MCP（工单与知识库）', link: '/tutorials/blog/2026/01/22/Cursor端到端工作流模板 Rules、Subagents、Skills、MCP（工单与知识库）' },
        { text: 'Everything Claude Code：Anthropic黑客松冠军的生产级配置库', link: '/tutorials/blog/2026/01/28/Everything-Claude-Code-Anthropic黑客松冠军的生产级配置库' },
      ],
    },
  ],
  ...
  '/ai/coding/': [
    ...
    },
    {
      ...
      collapsed: false,
      items: [
        { text: 'AI在开发中的应用', link: '/ai/coding/blog/2026/01/18/AI在开发中的应用' },
        { text: '大语言模型使用技巧', link: '/ai/coding/blog/2026/01/19/大语言模型使用技巧' },
        { text: 'AI工具对比分析', link: '/ai/coding/blog/2026/01/20/AI工具对比分析' },
        { text: 'AI辅助学习编程', link: '/ai/coding/blog/2026/01/21/AI辅助学习编程' },
        { text: '豆包AI无水印下载', link: '/ai/coding/blog/2026/01/22/doubao-downloader介绍' },
        { text: 'MCP协议使用指南', link: '/ai/coding/blog/2026/01/23/MCP协议使用指南' },
      ],
    },
    {
      text: '本栏目文章',
      ...
      collapsed: false,
      items: [
        { text: '国内AI芯片企业汇总', link: '/ai/coding/articles/2026/01/16/国内AI芯片企业汇总' },
        { text: 'SubAgent 与 Skills：AI Agent 的两种扩展方式', link: '/ai/coding/articles/2026/01/17/SubAgent与Skills：AI Agent的两种扩展方式' },
        { text: 'Skill与MCP深度对比', link: '/ai/coding/articles/2026/01/17/Skill与MCP深度对比' },
        { text: 'AI编程工具汇总对比', link: '/ai/coding/articles/2026/01/18/AI编程工具汇总对比' },
        { text: 'AI 画图（Draw.io）', link: '/ai/coding/articles/2026/01/22/AI驱动的图表创建工具-Next-AI-Draw-io' },
        { text: 'AI图像识别应用', link: '/ai/coding/articles/applications/2026/01/17/AI图像识别应用' },
        { text: 'AI代码生成实践', link: '/ai/coding/articles/applications/2026/01/18/AI代码生成实践' },
        { text: 'AI-IDE提示词工程', link: '/ai/coding/articles/learning/2026/01/18/AI-IDE提示词工程' },
      ],
    },
  ],
  ...
  '/ai/models/': [
    ...
    },
    {
      ...
      collapsed: false,
      items: [
        { text: '国内AI芯片企业汇总', link: '/ai/models/2026/01/16/国内AI芯片企业汇总' },
  ...
  '/ai/tools/': [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'AI 画图（Draw.io）', link: '/ai/tools/2026/01/22/AI驱动的图表创建工具-Next-AI-Draw-io' },
      ],
    },
  ],
  ...
  '/ai/learning/': [
    {
      ...
      collapsed: false,
      items: [
        { text: 'AI-IDE提示词工程', link: '/ai/learning/2026/01/18/AI-IDE提示词工程' },
      ],
    },
  ],
